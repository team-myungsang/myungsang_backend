...
//    private Long ACCESS_TOKEN_EXP_TIME;     //            // 30분 기준
    private Long ACCESS_TOKEN_EXP_TIME = new Long(12000000);

//    @Value("${security.expire.refreshtoken}")
//    private Long REFRESH_TOKEN_EXP_TIME;     //           // 7일 기준
    private Long REFRESH_TOKEN_EXP_TIME = new Long(604800000);

//    @Value("${security.secretkey}")
//    private String SECRET_KEY;   // 암/복호 키
    private String SECRET_KEY = "vnsdlavnlksavnioerjwiobnrisodfhguowehrgnjdsflnlnbvoansiovnosdnolsdfnbgosenbodfb";
